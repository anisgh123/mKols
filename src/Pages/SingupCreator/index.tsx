        ...
        <div>
            <div className="header">
                ...
                <div className="buttons-header">
                    ...
                    <button onClick={() => window.location.href = "/signupbusiness"} className="btn-sgnup">
                        Signup as Business
                    </button>
                </div>
            </div>
            <div className="signuppage">
                <div className="signupform">
                    ...
                    <p>Register and get access to actionable account insights, auto-updating media kits, and potential
